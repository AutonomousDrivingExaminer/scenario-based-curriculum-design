...
from adex_gym.criterions import CollisionTest
from adex_gym.navigation.common import RoadOption
...
class ScenicScenario(BasicScenario):
    ...
    def _generate_route(self, actor: carla.Vehicle, route: list[Lane], resolution=1.0) -> list[tuple[carla.Waypoint, RoadOption]]:
        ...
        waypoints = [
            (map.get_waypoint(actor.get_location()).transform, RoadOption.LANEFOLLOW)
        ]
