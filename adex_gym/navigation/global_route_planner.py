...
from adex_gym.navigation.misc import vector
...
class GlobalRoutePlanner(object):
    ...
    def __init__(self, carla_map: carla.Map, sampling_resolution: float):
    ...
    def trace_route(self, origin: carla.Location, destination: carla.Location) -> List[WaypointWithRoadOption]:
        """
